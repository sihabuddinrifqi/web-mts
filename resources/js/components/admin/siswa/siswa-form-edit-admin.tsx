...
export default function SiswaFormEditAdmin({ open, onOpenChange }: SiswaFormEditAdminProps) {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-h-screen overflow-y-auto sm:max-w-[625px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Perbarui informasi siswa sesuai data terbaru. Pastikan semua kolom terisi dengan benar untuk keperluan administrasi dan
                        akademik.
                    </DialogDescription>
                </DialogHeader>
