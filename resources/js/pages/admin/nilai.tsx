...
export default function AdminNilaiPage({ nilai, pelajaran, filters }: AdminNilaiPageProps) {
    ...
    const handleFilter = () => {
        router.get(route('admin.nilai.index'), {
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Kelola dan pantau data nilai siswa
                        </p>
                    </div>
