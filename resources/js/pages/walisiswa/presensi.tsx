...
interface WalisiswaPresensiPageProps {
...
export default function WalisiswaPresensiPage({ presensi, pelajaran, filters }: WalisiswaPresensiPageProps) {
    ...
    const handleFilter = () => {
        router.get(route('wali.presensi.index'), {
    ...
    return (
        <>
            <Head title="Data Presensi Anak" />
            <div className="space-y-6">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Data Presensi Anak</h1>
                        <p className="text-muted-foreground">
                            Pantau presensi anak Anda di pondok pesantren
                        </p>
                    </div>
