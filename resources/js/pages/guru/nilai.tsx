...
export default function GuruNilaiPage({ nilai, pelajaran, filters }: GuruNilaiPageProps) {
    ...
    const handleFilter = () => {
        router.get(route('guru.nilai.index'), {
    ...
    return (
        <>
            <Head title="Data Nilai Siswa Didik" />
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Data Nilai Siswa Didik</h1>
                        <p className="text-muted-foreground">
                            Pantau nilai siswa yang menjadi tanggung jawab Anda sebagai wali kelas
                        </p>
                    </div>
