...
Route::prefix('/api')
    ...
    ->group(
    function(){
        Route::get('/guru', [GuruManagerController::class, 'api'])
        ->name('guru');
        Route::get('/walisiswa', [WalisiswaManagerController::class, 'api'])
        ->name('walisiswa');
        Route::get('/siswa', [SiswaManagerController::class, 'api'])
        ->name('siswa');
        Route::get('/siswa/{angkatan}', [SiswaManagerController::class, 'angkatan'])
        ->name('siswa.angkatan');
        Route::get('/pelajaran', [PelajaranManagerController::class, 'api'])
        ->name('pelajaran');
        Route::get('/nilai/siswa/{siswa}', [NilaiController::class, 'APIsiswa'])
        ->name('nilai.siswa');
        Route::get('/walisiswa/anak', [WalisiswaController::class, 'APIanak'])
        ->name('walisiswa.anak');
        Route::prefix('/detail')
            ->name('detail.')
            ->group(
